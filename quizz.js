...
const backgroundMusic = document.getElementById("background-music"); // ✅ NEW
...
startButton.addEventListener("click", () => {
    ...
    if (backgroundMusic) {
        backgroundMusic.play().catch(e => {
            console.log("Background music autoplay blocked. Playing on user interaction.");
        });
    }
});
...
function loadQuestion() {
    ...
    currentQ.options.forEach((option, index) => {
        ...
        btn.addEventListener("click", () => selectAnswer(index, currentQ.answer, btn));
...
submitBtn.addEventListener("click", () => {
    ...
    if (playerName) {
        ...
        resultsScreen.classList.add("hidden"); //  Hide results when showing leaderboard
    }
});

//  Back to Start from Results screen
